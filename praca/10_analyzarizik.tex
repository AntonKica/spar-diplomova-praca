...
Analýza rizík je proces, ktorým identifikujeme, vyhodnocujeme a ošetrujeme riziká voči aktívam organizácie.
Podľa \cite{BSI3} tento proces pozostáva zo štyroch hlavných krokov a niekoľkých podkrokov (viď \ref{fig:risk-analysis-bsi3}).
...
\textbf{Implicitná} časť analýzy rizík je tá, ktorú za nás vykonal BSI a je súčasťou IT-Grundshcutz kompendia \cite{GSK}. BSI vybral
...
referujeme na \emph{implicitnú analýzu rizík}.
