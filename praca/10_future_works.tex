...
V poslednej kapitole by sme radi čitateľa zasvätili do problémov, vyhodených častiach a námetov na ďalšiu preskúmanie či záverečné práce.
...
systému alebo komponentov (pozri \ref{fig:abstraction-hierarchy}). \cite{CyBOK} sme nakoniec do práce nezakomponovali aj dôvodu, že ide o súbor teoretických poznatkov. 

\input{tikz/ras83-ra.tex}

Za zmienku stojí určite americký NIST a ich \emph{special publications} (špeciálne publikácie). Ktoré sú zamerané na informačnú bezpečnosť veľkých
...
hrozby v šiestich jadrových funkciách: riadiť, identifikovať, chrániť, zisťovať, reagovať a obnoviť. \cite{NIST-800/39} ani \cite{NIST-800/53} sme nakoniec v
práci nezahrnuli, nakoľko sa sústreďujú na pomery SŠA, ktoré sa líšia od tých v Európskej únii\footnote{Nehovoriac o tom, že spomínané publikácie sú veľmi zdĺhavé
a \enquote{ukecané}.}.
...
incidenty, ktoré môžu byť spúšťačom ďalšieho procesu analýzy rizík. Otázka znie, ako by sme mohli zakomponovať informáciu o uskutočnených bezpečnostných incidentoch?
Budeme uvažovať hrozbu alebo zraniteľnosť, ktorá bola využitá? Upozorníme používateľa, aby v kroku, kedy ošetruje riziko, zaviedol bezpečnostné opatrenia
minimalizujúce pravdepodobnosť/dopad opakovaného incidentu? Prinútime dodatočne používateľa posúdiť ošetrenie bezpečnostného incidentu v kroku
\enquote{IT-Grundschutz check}?
...
Snaha BSI a IT-Grundschutz zvýšiť bezpečnostnú úroveň organizácií a štátnych inštitúcií v Nemecku sa aj napriek dlhoročnej snahe zdá byť neúspešná.
...
Prezentované boli aj mnohé ďalšie zmeny a zlepšenia (aj ako odpoveď na požiadvky \cite{NIS2}), v praxi to znamená novú metodológiu a nové štandardy,
čím sa súčasný \cite{GSK} a jeho štandardy efektívne stanú zastaranými.