...
Samotný proces analýzy rizík má niekoľko predpokladov, ktoré potrebujeme splniť pred jej začatím \cite{BSI2}:
\begin{itemize}[nosep]
...
Postupnou implementáciou bezpečnostného konceptu sa dopracujeme ku kroku \emph{IT-Grundschutz check}, z ktorého nám vypadnú tzv. cieľové objekty
