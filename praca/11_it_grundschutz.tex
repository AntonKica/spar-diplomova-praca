\chapter{Štandardy BSI: IT-Grundschutz}
...
bezpečnosti (ISMS, viac v sekcii \nameref{sec:isms}) a kontinuálneho manažmentu informačnej bezpečnosti je rozpracovaná
...
IT-Grundschutz je kompatibilný s medzinárodnou sériou štandardov ISO/IEC 27000 a organizácie môžu svoj systém manažmentu
...
požiadavky vyplývajúce z \cite{ZoKB} alebo \cite{ZoITVS}\footnote{Skutočnosti, že oba zákony sú postavené na sérii
štandardov ISO/IEC 27000, sme sa venovali v \cite{BP}.}.
...
Spolkový úrad BSI analyzoval typické organizácie a identifikoval spoločné úlohy, procesy, problémy a ďalšie
...
Vo vyššie uvedených publikáciach BSI predkladá čitateľovi\footnote{Zamestnancovi poverenému informačnou bezpečnosťou.} 
podrobný návod na implementáciu systému základných (nevyhnutných) bezpečnostných opatrení. Štandardy rozoberajú rôzne
príklady, kladú otázky a ponúkajú potenciálne odpovede, aby vhodne usmernili proces zavádzania/správy informačnej
bezpečnosti v organizácii. Vďaka takémuto prístupu môže aj zamestnanec so základnou znalosťou informatiky a informačnej
bezpečnosti pozdvihnúť úroveň informačnej bezpečnosti v organizácii na požadovanú\footnote{Požadovanú v zmysle relevantného
zákona alebo štandardu pre účely certifikácie.} úroveň. 
...
a zastrešuje celý proces riadenia informačnej bezpečnosti v organizácii nazývame ISMS (z angl. \emph{information security
...
\textbf{Zamestnanci} prichádzajú do kontaktu s informačnými aktívami organizácie, a preto sa musia aktívne zapájať do KIB. Každý zamestnanec je
...
PDCA(\emph{angl. “Plan”, “Do”, “Check”, “Act”}) cyklom. Organizácia určí svoj stav a podmienky,
...
význam KIB a určuje povinnosti v KIB. Ciele a politika KIB sú ďalej rozvinuté a implementované pomocou konceptu KIB.
...
väčšie množstvo zdrojov.

Na obrázku \ref{fig:securuity-concept-bsi2} môžeme vidieť náčrt bezpečnostného konceptu pre
...
\textbf{Špecifikácia rozsahu} nám určuje rámec a rozsah bezpečnostného konceptu, v ktorom vykonávame bezpečnostný proces. Tento rozsah nazývame
...
zo základných hodnôt aktíva\footnote{Tu sa prvýkrát približujeme k analýze rizík, ale na vysokej úrovni, s tým rozdielom, že nezachádzame do technických detailov.}.
...
aktív uskutočňujeme interview, pričom usudzujeme mieru implementácie zvolených opatrení stavom: \emph{nepotrebný, implementovaný, neimplementovaný a čiastočne
    ...
    \begin{center}
        ...
        \begin{tabular}{ |p{0.15\textwidth}|p{0.45\textwidth}|p{0.40\textwidth}| }
            ...
            Séria štrukturovaných reprodukovateľných krokov alebo aktivít, ktoré organizácia vykonáva s cieľom splniť svoje úlohy alebo poslanie
                      &
            vývoj softvérového produktu na monitorovanie meteorologických podmienok, produkcia hardvérového zariadenia s meteorologickými prístrojmi 
            \\
            \hline
            aplikácia
                      &
            ...
            Fyzické priestory, v ktorých sa nachádzajú aktíva a sú prispôsobené ich potrebám.
                      &
                      \begin{itemize}[nosep]
                        \item serverová miestnosť
                        \item dátový archív
                        \item kancelárie
                        \item továrenská dielňa
                      \end{itemize}
            \\
            \hline
            komunikačné linky
            ...
            Fyzické alebo bezdrôtové prepojenie medzi IT, IoT alebo ICS systémami, ktoré sprostredkúva komunikáciu vrámci informačnej domény alebo do vonkajšieho sveta.
                      ...
                      \begin{itemize}[nosep]
                        \item switch
                        \item router
                        \item WLAN prístupový bod
                        \item internetové pripojenie
                        \item VLAN
                        \item VPN
                      \end{itemize}
            \\
...
rozklad nad množinou všetkých aktív. Uvedieme dva príklady, na ktorých ilustrujeme nejednoznačnosť kategorizácie aktív:
\begin{itemize}[nosep]
...
S kategóriami veľmi úzko súvisia moduly Kompendia IT-Grundschutz, s ktorými aj do veľkej miery korešpondujú. \cite{GSK} uplatňuje tzv. vrstvový model
(viď obrázok \ref{fig:gsk-layer-model}), ktorý môžeme interpretovať tak, že všetky moduly sú zastrešené ISMS, v základoch sú upevnené mechanizmami
detekcie a reakcie a systémové moduly sú pokryté procesnými modulmi.  

\input{tikz/gsk-layer-model}
...
potrebuje zakomponovať zamestnancov zodpovedných za organizačné celky aj ľudí kvalifikovaných v informačnej bezpečnosti. Odborné znalosti
môže čerpať napr. od IT špecialistov, ľudských zdrojov, audítorov alebo právneho oddelenia. Návrh a finálne znenie politiky predkladá
...
by mal byť čo najstručnejší a jasne formulovaný, nepokúšame sa vyrobiť príliš rozsiahly dokument, vzhľadom na to, že obsah
...
S politikou je potrebné oboznámiť všetkých (aj nových) zamestnancov, externých spolupracovníkov a dodávateľov služieb; preto,
je nutné ju zverejniť na ľahko prístupnom mieste.
Keďže v politike sú obsiahnuté nové úlohy a záväzné povinnosti, zamestnanci musia rozumieť jej obsahu, aby im bolo jasné, čo je od nich
požadované a aké sú očakávania. Rovnako aj prípadné sankcie, ktoré im budú uložene v prípade porušovania/nedodržiavania politiky.
Obsah politiky je potrebné v pravidelných intervaloch revidovať (každý rok alebo každé dva roky alebo v prípade výnimočnej udalosti),
aby sa systematicky prispôsobovala interným zmenám (napr. procesov, úloh, procedúr alebo komponentov) a externým zmenám (napr. legislatívy,
technológií alebo globálnych hrozieb).

Čitateľa sme vybavili potrebnými vedomosťami o KIB a ISMS, teraz môžme prejsť ku ďalšej kapitole, kde vysvetlíme proces analýzy rizík.