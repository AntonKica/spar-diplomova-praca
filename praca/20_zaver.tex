...
V súčastnosti, kedy je svet digitálne prepojený takmer na každej úrovni, je v spoločnosti veľká potreba KIB. Chýbajúci odborníci KIB na Slovensku
inšpirovali zadanie našej predošlej bakalárskej práce a neskôr aj tejto diplomovej práce. V zadaní sme si dali za úlohu vytvoriť široko koncipovaný
podporný systém na podporu analýzy rizík presahujúci rozsah diplomovej práce a kapacity jedného človeka.

Konfrontovaný skutočným rozsahom a komplexitou, ktorú by si expertný systém vyžadoval, sme si položili reálny cieľ: navrhnúť a implementovať
