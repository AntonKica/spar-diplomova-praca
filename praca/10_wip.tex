...
dopadu (\ref{tab:thrdmg}) a riziko (\ref{tab:thrimp}) \footnote{Samozrejme, pre našu organizáciu môže mať zmysel uvažovať aj nad menším/väčším
počtom úrovni (napr. $3x3x3$), ak to umožni sprehľadniť proces analýzy rizík.}.
\begin{table}[h!]
    \caption{Úrovne pravdepodobnosti}
    \label{tab:thrfreq}
    \begin{center}
        \footnotesize
        \begin{tabular}{ |p{0.20\textwidth}|p{0.80\textwidth}| }
